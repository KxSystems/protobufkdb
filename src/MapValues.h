...
#define MAP_VALUES_GET_ARGS \
  const gpb::Message& msg, const gpb::Reflection* refl, const gpb::FieldDescriptor* field, K k_list, int index
#define MAP_VALUES_SET_ARGS \
  gpb::Message* msg, const gpb::Reflection* refl, const gpb::FieldDescriptor* field, K k_list, int index
...
public:
  ...
  */
  K GetMap(const gpb::Message& msg, const gpb::Reflection* refl, const gpb::FieldDescriptor* field) const;
   ...
   * GetMap() otherwise a TypeCheck exception will be thrown.
   *
   * @param msg     Protobuf message containing the field
   * @param refl    Reflection interface to the message
   * @param field   FieldDescriptor of the map field to be populated
   * @param k_dict  Kdb dictionary from which the map keys/values are set
  */
  void SetMap(gpb::Message* msg, const gpb::Reflection* refl, const gpb::FieldDescriptor* field, K k_dict) const;
};
